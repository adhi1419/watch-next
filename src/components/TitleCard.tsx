...
export default function TitleCard({ title, posterUrl, imdbScore, tomatoMeter, year, totalSeasonCount, runtime, objectType, genres, isCompleted, isStopped, isSelected, progress, statusBadge, isPinned, onClick }: TitleCardProps) {
